    ...
    printBoardGrid(){
        ...
        for(let displayY=0; displayY<17; displayY++){
            for(let displayX=0; displayX<17; displayX++){
                ...
                gridDiv.removeClass('grid-dark grid-wall grid-exit grid-hint brown gray gold blue purple green clearblue bone woodbrown redbrown darkgray lightgray silver bloody').off('mouseleave mouseenter');
                let symbol = '';
                ...
                if(this.board.hasPlayerLos({x:x, y:y})){
                    ...
                    if(this.board.getDetail(x,y)){
                        gridDiv.addClass(this.board.getDetail(x,y));
                    }
                //out of sight
                }else{
                    gridDiv.addClass('grid-dark')
